                ...
                condition = (
                    <Aux>
                        <select
                            ...
                            onChange={event =>
                                this.props.onInputChange(event, this.props.id, 'condition')
                            }
                        >
                        ...
                        <input
                            ...
                            onChange={event =>
                                this.props.onInputChange(event, this.props.id, 'conditionValue')
                            }
                        />
                    </Aux>
                );
            ...
            <div className="InputEditBox" style={{ marginLeft: marginLeft }}>
                ...
                <div className="InputEditBox__buttons">
                    <InputButton
                        ...
                        onButtonClick={() =>
                            this.props.onInputDeletion(this.props.id, this.props.parent)
                        }
                    >
                        Delete
                    </InputButton>
